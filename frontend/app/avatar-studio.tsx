...
export default function AvatarStudioScreen() {
  ...
  const generate = useCallback(async () => {
    ...
    setGenStage('Preparing…'); setGenProgress(5);

    try {
      // Single-pass: image → talking avatar with personality-mapped voice.
      // In Phase B we'll insert the cartoonize pre-step when user opts-in.
      ...
      setGenStage('Generating your avatar video…');
  ...
  }, [imagePath, pickedDialogue, activeStyle, userIsPro, user]);
      ...
      <SafeAreaView style={s.root} edges={['top']}>
        ...
        >
          <GlassHeader
            ...
            subtitle={`Step ${step + 1} of 6 · ${STEP_TITLES[step]}`}
